...
local get_gps = function()
	...
	if not require("config.utils.functions").isempty(gps_location) then
		return "%#NavicSeparator#" .. ui.ChevronRight .. "%* " .. gps_location
	else
		return ""
	end
end
...
M.get_winbar = function()
	...
	if not f.isempty(value) and f.get_buf_option("mod") then
		...
		local mod = "%#LspCodeLens#" .. ui.Circle .. "%*"
		if gps_added then
			value = value .. " " .. mod
		else
			value = value .. mod
